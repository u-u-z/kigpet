  ...
  return (
    <div>
      ...
      <div className='p-12   bg-sky-200'>
        <div className=' bg-sky-50 rounded-lg shadow-lg justify-between -mt-24 flex flex-row items-center font-thin'>
          <div className='py-4 border-2   hover:border-2 rounded-lg hover:bg-sky-100 hover:cursor-pointer border-sky-50  hover:border-sky-800  m-2 px-4  lg:px-12 text-center flex flex-row justify-around items-center text-sky-800 text-2xl'>
      ...
      <div className='p-12  bg-sky-200'>
        <div className=' bg-white rounded-lg shadow-lg -mt-24 lg:-mt-20 p-12 text-sky-800'>
          <h2 className='text-sky-800 text-2xl font-bold mb-4'>已被收录的娃娃</h2>
          <div className='flex flex-row flex-wrap justify-center sm:justify-between items-center text-2xl font-thin'>
            {
              Array(8).fill(0).map((_, i) => {
                return <div key={i} className='border-2 p-2 rounded-lg border-sky-50 w-60 flex flex-row items-center mb-4'>
                  <Image src='/avatar/remi.jpg' width={90} height={90} className=' rounded-full border-2 border-sky-800 w-24' />
